 ...
 *   3. Uncomment the Sentry.init block below and import * as Sentry from '@sentry/react'
 *
...
const DSN = import.meta.env.VITE_ERROR_TRACKING_DSN as string | undefined
...
async function ingestError(err: Error, extra?: Record<string, unknown>) {
  try {
...
export const errorTracker = {
  ...
  captureException(err: Error, extra?: Record<string, unknown>) {
