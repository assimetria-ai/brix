...
const TYPE_COLORS: Record<CookieEntry['type'], string> = {
        ...
        <Section title="2. Types of Cookies We Use">
          ...
          <ul className="mt-4 space-y-3">
            {[
              {
                type: 'Essential',
                desc: 'Required for the website to function. They cannot be disabled without breaking core features such as authentication and security.',
              },
              {
                type: 'Functional',
              ...
              <li key={type} className="flex gap-3">
                <span
                  className={`mt-0.5 inline-flex shrink-0 items-center rounded-full px-2.5 py-0.5 text-xs font-medium ${TYPE_COLORS[type as CookieEntry['type']]}`}
                >
                  {type}
                </span>
