...
function CategoryGrid({ categories, onSelect }: { categories: HelpCategory[]; onSelect: (id: string) => void }) {
  return (
...
function PopularArticles({ articles }: { articles: HelpArticle[] }) {
...
function SearchResults({ articles, query }: { articles: HelpArticle[]; query: string }) {
