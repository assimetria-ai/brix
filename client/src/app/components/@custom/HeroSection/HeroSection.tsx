...
export interface HeroSectionProps {
  /** Badge text shown above the headline. Falsy = hidden. */
  badge?: string
  /** Main headline. Defaults to product name from info.ts */
  headline?: string
  /** Supporting subtitle. Defaults to product tagline from info.ts */
  subtitle?: string
  /** Primary CTA label (shown to unauthenticated visitors) */
  ctaLabel?: string
  /** Primary CTA link */
  ctaHref?: string
  /** Secondary CTA label */
  ...
  /** Label shown when user is already authenticated */
