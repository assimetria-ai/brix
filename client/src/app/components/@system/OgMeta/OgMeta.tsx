...
export interface OgMetaProps {
  /** Page title (also sets <title> and og:title / twitter:title) */
  title?: string
  /** Short description for og:description / twitter:description / meta description */
  description?: string
  /** Absolute URL of the OG image (1200×630 recommended) */
  image?: string
  /** Canonical page URL — defaults to info.url */
  url?: string
  /** og:type — defaults to 'website' */
  type?: 'website' | 'article' | 'product'
  /** Twitter card size — defaults to 'summary_large_image' */
